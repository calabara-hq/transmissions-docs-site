...
### Terminology
* Channel - An ERC-1155 collection. The foundational entity of the protocol.
* Transport Layer - Application specific contracts sitting on top of channels. Transport layers can support different functionality by overriding 3 virtual functions.
...
In addition, Channel.sol calls to 2 external contracts to manage mint fees and interaction logic. Any fee or logic contract can be passed to the channel. The initial protocol release comes with:
